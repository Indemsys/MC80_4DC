...
#define VT100_TASKS_MAX_NUM    5  // Maximum number of simultaneously running VT100 tasks in the system
...
#define VT100_CR               0x0D  // name conflict with peripheral registers
...
#define GET_MCBL                                                                   \
  T_monitor_cbl      *mcbl = (T_monitor_cbl *)(tx_thread_identify()->environment); \
