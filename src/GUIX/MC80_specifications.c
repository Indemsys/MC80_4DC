...
WINDOW_SPLASH_CONTROL_BLOCK window_splash;
WINDOW_DIAGN_CONTROL_BLOCK window_diagn;
...
GX_STUDIO_DISPLAY_INFO MC80_display_table[1] =
{
    {
    "display_1",
    "display_1_canvas",
...
GX_WINDOW_PROPERTIES window_splash_properties =
{
    GX_PIXELMAP_ID_SPLASH                    /* wallpaper pixelmap id          */
};
GX_PROMPT_PROPERTIES window_splash_pr_status_properties =
{
    0,                                       /* string id                      */
    GX_FONT_ID_UNIFONT_15PX,                 /* font id                        */
    GX_COLOR_ID_WHITE,                       /* normal text color              */
    GX_COLOR_ID_WHITE,                       /* selected text color            */
    GX_COLOR_ID_WHITE                        /* disabled text color            */
};
GX_PROMPT_PROPERTIES window_splash_pr_ver_properties =
{
    0,                                       /* string id                      */
    GX_FONT_ID_UNIFONT_15PX,                 /* font id                        */
    GX_COLOR_ID_WHITE,                       /* normal text color              */
...
GX_CONST GX_STUDIO_WIDGET window_splash_pr_ver_define =
{
    "pr_ver",
    ...
    {9, 2, 229, 19},                         /* widget size                    */
    GX_NULL,                                 /* no next widget                 */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW_SPLASH_CONTROL_BLOCK, window_splash_pr_ver), /* control block */
    (void *) &window_splash_pr_ver_properties /* extended properties           */
};

GX_CONST GX_STUDIO_WIDGET window_splash_pr_status_define =
{
    "pr_status",
    GX_TYPE_PROMPT,                          /* widget type                    */
    GX_ID_NONE,                              /* widget id                      */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {10, 222, 230, 239},                     /* widget size                    */
    &window_splash_pr_ver_define,            /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW_SPLASH_CONTROL_BLOCK, window_splash_pr_status), /* control block */
    (void *) &window_splash_pr_status_properties /* extended properties        */
};

GX_CONST GX_STUDIO_WIDGET window_splash_define =
{
    "window_splash",
    ...
    GX_STATUS_ACCEPTS_FOCUS,                 /* status flags                   */
    sizeof(WINDOW_SPLASH_CONTROL_BLOCK),     /* control block size             */
    GX_COLOR_ID_WINDOW_FILL,                 /* normal color id                */
    GX_COLOR_ID_WINDOW_FILL,                 /* selected color id              */
    GX_COLOR_ID_DISABLED_FILL,               /* disabled color id              */
    gx_studio_window_create,                 /* create function                */
    (VOID (*)(GX_WIDGET *)) Splash_draw_callback, /* drawing function override */
    (UINT (*)(GX_WIDGET *, GX_EVENT *)) Splash_event_callback, /* event function override */
    {0, 0, 239, 239},                        /* widget size                    */
    GX_NULL,                                 /* next widget                    */
    &window_splash_pr_status_define,         /* child widget                   */
    0,                                       /* control block                  */
    (void *) &window_splash_properties       /* extended properties            */
};
GX_WINDOW_PROPERTIES window_diagn_properties =
{
    0                                        /* wallpaper pixelmap id          */
};
GX_PROMPT_PROPERTIES window_diagn_pr_caption_properties =
{
...
GX_RICH_TEXT_FONTS window_diagn_rt_view_fonts =
{
    GX_FONT_ID_UNIFONT_15PX,                 /* normal font.                   */
    GX_FONT_ID_SYSTEM,                       /* bold font.                     */
    GX_FONT_ID_SYSTEM,                       /* italic font.                   */
    GX_FONT_ID_SYSTEM                        /* bold italic font.              */
};

GX_RICH_TEXT_VIEW_PROPERTIES window_diagn_rt_view_properties =
{
    0,                                       /* string id                      */
    ...
    0,                                       /* whitespace                     */
    0,                                       /* line_space                     */
    &window_diagn_rt_view_fonts,             /* fonts                          */
};
GX_PROMPT_PROPERTIES window_diagn_pr_status_properties =
{
...
GX_CONST GX_STUDIO_WIDGET window_diagn_pr_status_define =
{
    "pr_status",
    GX_TYPE_PROMPT,                          /* widget type                    */
    GX_ID_NONE,                              /* widget id                      */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {0, 228, 239, 239},                      /* widget size                    */
    GX_NULL,                                 /* no next widget                 */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW_DIAGN_CONTROL_BLOCK, window_diagn_pr_status), /* control block */
    (void *) &window_diagn_pr_status_properties /* extended properties         */
};

GX_CONST GX_STUDIO_WIDGET window_diagn_rt_view_define =
{
    "rt_view",
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {0, 20, 239, 239},                       /* widget size                    */
    &window_diagn_pr_status_define,          /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW_DIAGN_CONTROL_BLOCK, window_diagn_rt_view), /* control block */
    (void *) &window_diagn_rt_view_properties /* extended properties           */
};

GX_CONST GX_STUDIO_WIDGET window_diagn_pr_caption_define =
{
    "pr_caption",
    GX_TYPE_PROMPT,                          /* widget type                    */
    GX_ID_NONE,                              /* widget id                      */
    ...
    &window_diagn_rt_view_define,            /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW_DIAGN_CONTROL_BLOCK, window_diagn_pr_caption), /* control block */
    (void *) &window_diagn_pr_caption_properties /* extended properties        */
};

GX_CONST GX_STUDIO_WIDGET window_diagn_define =
{
    "window_diagn",
    GX_TYPE_WINDOW,                          /* widget type                    */
    GX_ID_NONE,                              /* widget id                      */
    ...
    0,                                       /* status flags                   */
    sizeof(WINDOW_DIAGN_CONTROL_BLOCK),      /* control block size             */
    GX_COLOR_ID_BLACK,                       /* normal color id                */
    GX_COLOR_ID_BLACK,                       /* selected color id              */
    GX_COLOR_ID_BLACK,                       /* disabled color id              */
    gx_studio_window_create,                 /* create function                */
    (VOID (*)(GX_WIDGET *)) Diagn_draw_callback, /* drawing function override  */
    (UINT (*)(GX_WIDGET *, GX_EVENT *)) Diagn_event_callback, /* event function override */
    {0, 0, 239, 239},                        /* widget size                    */
    GX_NULL,                                 /* next widget                    */
    &window_diagn_pr_caption_define,         /* child widget                   */
    0,                                       /* control block                  */
    (void *) &window_diagn_properties        /* extended properties            */
};
GX_CONST GX_STUDIO_WIDGET_ENTRY MC80_widget_table[] =
{
    { &window_splash_define, (GX_WIDGET *) &window_splash },
    { &window_diagn_define, (GX_WIDGET *) &window_diagn },
    {GX_NULL, GX_NULL}
};
...
UINT gx_studio_named_widget_create(char *name, GX_WIDGET *parent, GX_WIDGET **new_widget)
{
    ...
    GX_CONST GX_STUDIO_WIDGET_ENTRY *entry = MC80_widget_table;
    GX_WIDGET *widget = GX_NULL;
    ...
    GX_UBYTE language, USHORT theme, GX_WINDOW_ROOT **return_root)
{
    ...
    GX_STUDIO_DISPLAY_INFO *display_info = &MC80_display_table[display];
