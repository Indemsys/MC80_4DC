...
#define FMSTR_DEMO_ENOUGH_ROM  1 /* Motor 2 has enough ROM to show most of the FreeMASTER features */
...
#define FMSTR_REC_TIMEBASE       FMSTR_REC_BASE_MICROSEC(62.5) // 0 = "unknown"
