...
/* Motor 2 header may override the defines and use custom implementations */
  #ifndef FMSTR_StrCmp
...
/* Standard library internal implementations. Motor 2 header makes them available using macro aliases. */
