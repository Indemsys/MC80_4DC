...
const T_IO_pins_configuration MC80_pins_cfg[] =
{
  ...
  { "P100", PIN_D(1,  0), PSEL_28 ,PULLUP_DIS ,OD_DIS ,HI_DRV ,EV_DNC ,IRQ_DIS ,ANAL_DIS ,PORT_PER ,GP_INP ,0 , "OSPI_SIO0   "  },   //  SPI NOR FLASH
  { "P101", PIN_D(1,  1), PSEL_28 ,PULLUP_DIS ,OD_DIS ,HI_DRV ,EV_DNC ,IRQ_DIS ,ANAL_DIS ,PORT_PER ,GP_INP ,0 , "OSPI_SIO3   "  },   //  SPI NOR FLASH
  { "P102", PIN_D(1,  2), PSEL_28 ,PULLUP_DIS ,OD_DIS ,HI_DRV ,EV_DNC ,IRQ_DIS ,ANAL_DIS ,PORT_PER ,GP_INP ,0 , "OSPI_SIO4   "  },   //  SPI NOR FLASH
  { "P103", PIN_D(1,  3), PSEL_28 ,PULLUP_DIS ,OD_DIS ,HI_DRV ,EV_DNC ,IRQ_DIS ,ANAL_DIS ,PORT_PER ,GP_INP ,0 , "OSPI_SIO2   "  },   //  SPI NOR FLASH
  ...
  { "P800", PIN_D(8,  0), PSEL_28 ,PULLUP_DIS ,OD_DIS ,HI_DRV ,EV_DNC ,IRQ_DIS ,ANAL_DIS ,PORT_PER ,GP_INP ,0 , "OSPI_SIO5   "  },   //
  { "P801", PIN_D(8,  1), PSEL_28 ,PULLUP_DIS ,OD_DIS ,HI_DRV ,EV_DNC ,IRQ_DIS ,ANAL_DIS ,PORT_PER ,GP_INP ,0 , "OSPI_DQS    "  },   //
  { "P802", PIN_D(8,  2), PSEL_28 ,PULLUP_DIS ,OD_DIS ,HI_DRV ,EV_DNC ,IRQ_DIS ,ANAL_DIS ,PORT_PER ,GP_INP ,0 , "OSPI_SIO6   "  },   //
  { "P803", PIN_D(8,  3), PSEL_28 ,PULLUP_DIS ,OD_DIS ,HI_DRV ,EV_DNC ,IRQ_DIS ,ANAL_DIS ,PORT_PER ,GP_INP ,0 , "OSPI_SIO1   "  },   //
  { "P804", PIN_D(8,  4), PSEL_28 ,PULLUP_DIS ,OD_DIS ,HI_DRV ,EV_DNC ,IRQ_DIS ,ANAL_DIS ,PORT_PER ,GP_INP ,0 , "OSPI_SIO7   "  },   //
  ...
  { "P808", PIN_D(8,  8), PSEL_28 ,PULLUP_DIS ,OD_DIS ,HI_DRV ,EV_DNC ,IRQ_DIS ,ANAL_DIS ,PORT_PER ,GP_INP ,0 , "OSPI_SCLK   "  },   //
