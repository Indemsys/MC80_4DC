...
-----------------------------------------------------------------------------------------------------*/
float RunAverageFilter_float_N(T_run_average_float_N *fltr, float inp )
{
  uint32_t i;
  if (fltr->init == 0)
  {
...
-----------------------------------------------------------------------------------------------------*/
int32_t RunAverageFilter_int32_N(T_run_average_int32_N *fltr, int32_t inp)
{
  uint32_t i;
  if (fltr->init == 0)
  {
...
/*-----------------------------------------------------------------------------------------------------
  ...
  \return int32_t
-----------------------------------------------------------------------------------------------------*/
int32_t Exponential_filter_int32(T_exp_filter *flt, int32_t input )
{
  int32_t outp;
...
/*-----------------------------------------------------------------------------------------------------
  Экспоненциальный  фильтр c плавающей точкой
