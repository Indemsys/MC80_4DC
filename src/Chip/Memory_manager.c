...
/*-----------------------------------------------------------------------------------------------------
  ...
  \return uint32_t
-----------------------------------------------------------------------------------------------------*/
static uint32_t RAM_pool_create(void *first_unused_memory)
{
  ram_memory_pool      = (uint8_t *)first_unused_memory;
  ram_memory_pool_size = RAM_END - (uint32_t)ram_memory_pool;
...
{
  RAM_pool_create(first_unused_memory);
