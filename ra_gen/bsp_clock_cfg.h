...
#define BSP_CFG_PLL1P_FREQUENCY_HZ (240000000) /* PLL1P 240000000Hz */
...
#define BSP_CFG_PLL2_MUL BSP_CLOCKS_PLL_MUL(64,0) /* PLL2 Mul x60-79|Mul x64|PLL2 Mul x64.00 */
...
#define BSP_CFG_U60CK_SOURCE (BSP_CLOCKS_SOURCE_CLOCK_PLL1Q) /* U60CK Src: PLL1Q */
...
#define BSP_CFG_PCLKE_DIV (BSP_CLOCKS_SYS_CLOCK_DIV_1) /* PCLKE Div /1 */
...
#define BSP_CFG_CANFDCLK_DIV (BSP_CLOCKS_CANFD_CLOCK_DIV_3) /* CANFDCLK Div /3 */
...
#define BSP_CFG_U60CK_DIV (BSP_CLOCKS_USB_CLOCK_DIV_4) /* U60CK Div /4 */
