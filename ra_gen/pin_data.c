...
const ioport_pin_cfg_t g_bsp_pin_cfg_data[] = {
    ...
    },
    {
        ...
        .pin_cfg = ((uint32_t) IOPORT_CFG_PERIPHERAL_PIN | (uint32_t) IOPORT_PERIPHERAL_DE_SCI1_3_5_7_9 | (uint32_t) IOPORT_PERIPHERAL_SCI1_3_5_7_9)
    },
    {
...
// Эту структуру не используем и обнуляем ее члены, чтобы не происходила инициализация поскольку пины переопределили в другой функции
const ioport_cfg_t g_bsp_pin_cfg = {
    .number_of_pins = 0, // sizeof(g_bsp_pin_cfg_data)/sizeof(ioport_pin_cfg_t),
    .p_pin_cfg_data = 0  // &g_bsp_pin_cfg_data[0],
};
